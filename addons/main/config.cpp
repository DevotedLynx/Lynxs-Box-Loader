...
class CfgPatches {
    class ADDON {
        ...
        authors[] = {"ValkyrieLynx"}; // sub array of authors, considered for the specific addon
        author = "ValkyrieLynx"; // primary author name, either yours or your team's, considered for the whole mod
        VERSION_CONFIG;
    };
};
...
class CfgMods {
    class PREFIX {
        dir = "@LBL";
        name = "Lynx's Boxloader";
        
        author = "ValkyrieLynx";                    // probably shown somewhere in the mods menu, but probably ignored by CBA/HEMTT
        ...
        action          = "https://www.discord.com/JxAcEcTVCP"; // Website URL, that can accessed from the expansions menu 
